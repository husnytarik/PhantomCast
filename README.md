...
- **Infinite Flexibility:** You can bind any key or key combination to any facial expression or hand gesture. The usage is completely up to your imagination!
...
1. Clone the repository:
   git clone https://github.com/husnytarik/PhantomCast.git
   cd PhantomCast
...
3. Assign your desired keys in the KEY ASSIGNMENTS section.
...
- **Sınırsız Özgürlük:** Dilediğiniz herhangi bir tuşu veya tuş kombinasyonunu, dilediğiniz yüz mimiğine veya el hareketine atayabilirsiniz. Kullanım alanı tamamen hayal gücünüze kalmış!
...
3. KEY ASSIGNMENTS (Tuş Atamaları) bölümünden istediğiniz tuşları belirleyin.
